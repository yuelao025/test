...
class Services_Parsedown
{
    ...
    //用于识别当前输出的html是否还有code标签然后是否加载代码高亮 见88行
...
//            //高亮样式=styles路径下的文件名 官方有例子可参照!
//            TPL::import_css('js/editormd/css/prettify.css');
//            //用于初始化,当然你有更好的办法可以更改
//            $this->on_js = '<script>$(document).ready(function(){ prettyPrint() });</script>';
//            return  $this->on_js;
